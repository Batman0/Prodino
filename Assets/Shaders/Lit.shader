    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                return fixed4(_node_9840.rgb,0);
            }
            ENDCG
        }
        Pass {
